...
namespace NAudio.Win8.Wave.WaveOutputs
{
    ...
    public class WasapiOutRT : IWavePlayer
    {
        ...
        private async void PlayThread()
        {
            ...
            try
            {
                if (ShouldCreateResampler)
                {
                    mediaFoundationResampler = CreateResampler(sourceProvider, outputFormat);
        ...
        /// <summary>
        /// Indicate if a resampler should be created or not
        /// </summary>
        protected virtual bool ShouldCreateResampler
        {
            get
            {
                return this.resamplerNeeded;
            }
        }
