...
namespace NAudio.MediaFoundation
{
    ...
    public abstract class MediaFoundationTransform : IWaveProvider, IDisposable
    {
        ...
        /// <summary>
        /// Computes the output buffer size
        /// </summary>
        /// <param name="outputFormat"></param>
        /// <returns></returns>
        protected virtual int ComputeOutputBufferSize(WaveFormat outputFormat)
        {
            return outputWaveFormat.AverageBytesPerSecond + outputWaveFormat.BlockAlign;
        }

        /// <summary>
        /// Computes the source buffer size
        /// </summary>
        /// <param name="sourceProvider"></param>
        /// <returns></returns>
        protected virtual int ComputeSourceBufferSize(IWaveProvider sourceProvider)
        {
            return sourceProvider.WaveFormat.AverageBytesPerSecond;
        }
